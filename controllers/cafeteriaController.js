...
const addItem = async (req, res) => {
    ...
    try {
        ...
        const newItem = await Cafeteria.create({
            item,
            price,
            image
        });
...
const findOne = async (req, res) => {
    ...
    try {
        ...
        const item = await Cafeteria.findById({ _id:Id });
...
const getAll = async (req, res) => {
    try {
        const items = await Cafeteria.find({});
...
const deleteItem = async (req, res) => {
    ...
    try {
        ...
        const resultat = await Cafeteria.findByIdAndDelete({ _id:Id });
...
const updateItem = async (req, res) => {
    ...
    try {
        ...
        var resultat = "";
        if(req.file){
            resultat = await Cafeteria.findByIdAndUpdate({ _id:Id }, { item, price, image});
        }
        else{
            resultat = await Cafeteria.findByIdAndUpdate({ _id:Id }, { item, price});
        }
